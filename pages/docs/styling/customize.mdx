...
:root {
  ...
  --wkit-font-family: 'Satoshi', sans-serif;
...
```scss title="./razor-kit-custom.css"
:root {
...
For example, in the `src/index.tsx` file:

```tsx title="src/index.tsx" twoslash
import '@razorlabs/razorkit/style.css';
import './razor-kit-custom.css'; // You CSS file here
```
